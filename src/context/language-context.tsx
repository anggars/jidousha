...
export const translations = {
  en: {
    ...
    requestAccess: "Request Full Access via Email",
    guestEndMsg: "You have reached the end of the Guest Mode preview (5 questions).",
    contactAdminMsg: "Please contact the admin via anggarnts@gmail.com to unlock all questions!",
  ...
  id: {
    ...
    requestAccess: "Minta Akses Penuh via Email",
    guestEndMsg: "Anda telah mencapai akhir pratinjau Mode Tamu (5 soal).",
    contactAdminMsg: "Silakan hubungi admin via anggarnts@gmail.com untuk membuka semua soal!",
