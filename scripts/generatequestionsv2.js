...
const questions = [
  ...
  },
  {
    ...
    optionsIndonesian: ["Pasang probe merah (+) ke terminal '+' baterai.", "Pasang probe merah (+) ke terminal '-' baterai."],
    optionsEnglish: ["Attach the red probe (+) to the battery's '+' terminal.", "Attach the red probe (+) to the battery's '-' terminal."],
  ...
  },
  {
    ...
    options: ["1x", "100x"],
    optionsIndonesian: ["1x", "100x"],
    optionsEnglish: ["1x", "100x"],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ["20 Ω", "2000 Ω"],
    optionsIndonesian: ["20 Ω", "2000 Ω"],
    optionsEnglish: ["20 Ω", "2000 Ω"],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ["画像A", "画像B"],
    optionsIndonesian: ["Gambar A", "Gambar B"],
    optionsEnglish: ["Image A", "Image B"],
  ...
  },
  {
    ...
    options: ["ノギス", "マイクロメータ"],
    optionsIndonesian: ["Jangka Sorong (Vernier Caliper)", "Mikrometer"],
    optionsEnglish: ["Vernier Caliper", "Micrometer"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    optionsIndonesian: ["Dikencangkan secara menyilang (diagonal/silang).", "Dikencangkan secara berurutan searah jarum jam."],
    optionsEnglish: ["Tighten in a criss-cross (diagonal) pattern.", "Tighten sequentially in a clockwise direction."],
    correctAnswer: 0,
  ...
  },
  {
    ...
    optionsIndonesian: ["Dikencangkan sekaligus dalam 1 kali tarikan.", "Dikencangkan secara bertahap dalam 2 hingga 3 kali siklus putaran."],
    optionsEnglish: ["Tighten completely in one go.", "Tighten gradually in 2 to 3 stages."],
    correctAnswer: 1,
  ...
  },
  {
    ...
    optionsIndonesian: ["26.35 mm", "36.35 mm"],
    optionsEnglish: ["26.35 mm", "36.35 mm"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    optionsIndonesian: ["Lakukan berurutan dari ujung ke ujung.", "Lakukan dengan pola menyilang (cross) dari tengah menuju ke arah luar."],
    optionsEnglish: ["Do it sequentially from one end to the other.", "Do it in a criss-cross pattern starting from the center outward."],
    correctAnswer: 1,
